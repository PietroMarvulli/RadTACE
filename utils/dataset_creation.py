...
#                 n = str(i)+".png"
#                 output = os.path.join(dest_path_srs,patient,n)
...
#     id = row['ID']
#     value = row['value']
#     source = os.path.join(dest_path_srs,str(id),str(value)+".png")
#     ante_source = os.path.join(dest_path_srs,str(id),str(value - 1)+".png")
#     post_source = os.path.join(dest_path_srs,str(id),str(value + 1)+".png")
#     dest = os.path.join(dest_path_img,str(id),str(0)+".png")
#     ante_dest = os.path.join(dest_path_img, str(id), str(-1) + ".png")
#     post_dest = os.path.join(dest_path_img, str(id), str(+1) + ".png")
#     try:
